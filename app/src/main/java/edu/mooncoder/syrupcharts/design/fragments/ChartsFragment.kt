 ...
 */
class ChartsFragment(private val chartifyCode: ChartifyCode) : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view: View = inflater.inflate(R.layout.fragment_charts, container, false)

        chartsList = view.findViewById(R.id.chart_list)

        val chartAdapter = ChartAdapter()
        chartAdapter.charts = chartifyCode.charts!!
    ...
    companion object {
        ...
        fun newInstance(
            param1: String,
            param2: String,
            chartifyCode: ChartifyCode
        ): ChartsFragment {
            return ChartsFragment(chartifyCode).apply {
